                            ...
                            <Grid item xs={12}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {items.map(app => {
                                            return (<option key={app._id} aria-label={app.name} value={app._id}>{app.name}</option>)
                                        })}
                                    </Select>
                                    {touched.item && <FormHelperText>{errors.item}</FormHelperText>}
                                </FormControl>
                            </Grid>
                            <Grid item xs={12}>
